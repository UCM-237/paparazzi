...
extern void bare_create_bezier_spline(bare_bezier_t *bezier, float *px, float *py);
extern void gvf_parametric_bare_2d_bezier_splines_info(bare_bezier_t *bezier, float *f1, float *f2, float *f1d, float *f2d, float *f1dd, float *f2dd);
